...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'roboclaw' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/samer/catkin_ws/install/${idir}'.  Ask the maintainer 'bcharrow <bcharrow@seas.upenn.edu>' to fix it.")
    endif()
