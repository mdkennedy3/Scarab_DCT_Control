...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_client_SOURCE_PREFIX /home/samer/catkin_ws/src/rosserial/rosserial_client)
  set(rosserial_client_DEVEL_PREFIX /home/samer/catkin_ws/devel)
  ...
  set(rosserial_client_INSTALL_PREFIX /home/samer/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosserial_client' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosserial_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/samer/catkin_ws/src/rosserial/rosserial_client/${idir}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>' to fix it.")
    endif()
