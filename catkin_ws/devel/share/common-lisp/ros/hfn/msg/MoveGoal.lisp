...
(cl:defmethod cl:initialize-instance :after ((m <MoveGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hfn-msg:<MoveGoal> is deprecated: use hfn-msg:MoveGoal instead.")))

(cl:ensure-generic-function 'stop-val :lambda-list '(m))
(cl:defmethod stop-val ((m <MoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hfn-msg:stop-val is deprecated.  Use hfn-msg:stop instead.")
  (stop m))

(cl:ensure-generic-function 'target_poses-val :lambda-list '(m))
(cl:defmethod target_poses-val ((m <MoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hfn-msg:target_poses-val is deprecated.  Use hfn-msg:target_poses instead.")
  (target_poses m))
