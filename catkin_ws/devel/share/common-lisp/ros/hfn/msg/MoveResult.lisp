...
(cl:defmethod cl:initialize-instance :after ((m <MoveResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hfn-msg:<MoveResult> is deprecated: use hfn-msg:MoveResult instead.")))

(cl:ensure-generic-function 'final_status-val :lambda-list '(m))
(cl:defmethod final_status-val ((m <MoveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hfn-msg:final_status-val is deprecated.  Use hfn-msg:final_status instead.")
  (final_status m))
