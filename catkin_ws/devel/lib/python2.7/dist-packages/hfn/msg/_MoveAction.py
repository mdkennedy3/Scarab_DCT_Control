"""autogenerated by genpy from hfn/MoveAction.msg. Do not edit."""
import sys
...
class MoveAction(genpy.Message):
  _md5sum = "07d7c30ecabfe3a821c8440f3b19d323"
  _type = "hfn/MoveAction"
...
"""
  ...
  _slot_types = ['hfn/MoveActionGoal','hfn/MoveActionResult','hfn/MoveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = hfn.msg.MoveActionGoal()
      if self.action_result is None:
        self.action_result = hfn.msg.MoveActionResult()
      if self.action_feedback is None:
        self.action_feedback = hfn.msg.MoveActionFeedback()
    else:
      self.action_goal = hfn.msg.MoveActionGoal()
      self.action_result = hfn.msg.MoveActionResult()
      self.action_feedback = hfn.msg.MoveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.action_goal.goal.stop))
      length = len(self.action_goal.goal.target_poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.target_poses:
        _v1 = val1.header
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_result.result.final_status, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.stop,) = _struct_B.unpack(str[start:end])
      self.action_goal.goal.stop = bool(self.action_goal.goal.stop)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.target_poses = []
      for i in range(0, length):
        ...
        self.action_goal.goal.target_poses.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.final_status, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
