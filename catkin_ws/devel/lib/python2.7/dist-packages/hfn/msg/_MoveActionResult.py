"""autogenerated by genpy from hfn/MoveActionResult.msg. Do not edit."""
import sys
...
class MoveActionResult(genpy.Message):
  _md5sum = "c20c80cd33a84887e2fce9a23c8c151f"
  _type = "hfn/MoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hfn/MoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = hfn.msg.MoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hfn.msg.MoveResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.result.final_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.final_status,) = _struct_B.unpack(str[start:end])
      return self
